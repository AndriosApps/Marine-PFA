...
public void shareLog(){
			...
			if(market.equals("amazon")){
				picMessageIntent.putExtra(Intent.EXTRA_TEXT, "CFT Score: " + entry.getTotalScore() + " @Andrios_Apps http://www.amazon.com/gp/mas/dl/android?p=com.andrios.marinepft #USMC");
			}else{
