...
public class Profile extends Observable implements Serializable{
	...
	public Profile(){
		...
		nextPFT = Calendar.getInstance();

		nextCFT = Calendar.getInstance();
	...
	public Calendar getNextPFT(){
		return nextPFT;
	}
	
	public Calendar getNextCFT(){
		return nextCFT;
	}
	...
	public void setPFT(Calendar c){
		this.nextPFT = c;
		setChanged();
		notifyObservers();
	}
	
	public void setCFT(Calendar c){
		this.nextCFT = c;
		setChanged();
		notifyObservers();
	}
